...
public final class ComplexNumber {
    ...
    public boolean equals(Object obj){
        ...
        return (obj instanceof ComplexNumber)
            && (Double.doubleToLongBits(((ComplexNumber)obj).re) == Double.doubleToLongBits(this.re)
                && Double.doubleToLongBits(((ComplexNumber)obj).im) == Double.doubleToLongBits(this.im));
    }
}