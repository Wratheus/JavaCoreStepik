...
private static void configureLogging() {
    final Logger classALogger = Logger.getLogger("org.stepic.java.logging.ClassA");
    classALogger.setLevel(Level.ALL);
    final Logger classBLogger = Logger.getLogger("org.stepic.java.logging.ClassB");
    classBLogger.setLevel(Level.WARNING);
    final Logger restLogger = Logger.getLogger("org.stepic.java");
